// client/src/constants/ntokozoMasteryExtended.ts
// NTOKOZO BANDA — Extended Mastery Tracks
// Based on Codist profile: .NET 8, Angular, Flutter, PostgreSQL, Hetzner, Paystack
// Add these tracks and drills to the existing ntokozoMastery.ts
...
// ═══════════════════════════════════════════════════
// HOW TO ADD THESE TRACKS TO ntokozoMastery.ts
// ═══════════════════════════════════════════════════

/*
In client/src/constants/ntokozoMastery.ts:

1. Import the extended tracks:
   import {
...
2. Add to the TRACKS array:
   export const NTOKOZO_MASTERY_TRACKS = [
     SENIOR_VS_LEAD_TRACK,      // existing
     ARCHITECTURE_TRACK,         // existing
     RESILIENCE_TRACK,           // existing
     SECURITY_TRACK,             // existing
     AZURE_DEPLOY_TRACK,         // existing
     CSHARP_CHALLENGES_TRACK,    // existing
     PAYMENTS_FINTECH_TRACK,     // NEW
     MULTI_TENANT_TRACK,         // NEW
     DOCKER_OPS_TRACK,           // NEW
     SA_TECH_CONTEXT_TRACK,      // NEW
   ];

3. The left rail will automatically show the new tracks.
   The drill count, code count, and definition count
   are computed from the arrays.
...
GRAND TOTAL WITH EXISTING:
  Drills:      44 + 15 = 59
  Code drills: 13 + 4  = 17
  Definitions: 57 + 35 = 92
*/
